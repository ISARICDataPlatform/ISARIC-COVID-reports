...
uk.version <- 'CCPUKSARI_DATA_2020-03-19_1327.csv'
intl.version <- 'ISARICnCoV_DATA_2020-03-19_1326.csv'
...
source("/Users/mdhall/ISARIC-COVID-dashboard/shared.R")
source("shiny/COVID-dashboard/functions2.R")
data <- read.csv("data/data.v4.csv")
...
The results in this report have been produced using data from the  International Severe Acute Respiratory and Emerging Infection Consortium (ISARIC) COVID-19 database up to 19 March 2020. This data were contributed by 65 sites across 15 countries, 


Up to 19 March 2020, data have been entered for 408 patients. The cohort is made up of 191 males and 147 females - sex is unreported for 70 cases. The median age (calculated based on reported ages) is 50 years. Follow-up is ongoing for 292 patients. 12 patients have died.


Among this cohort, there was no significant difference in the duration from admission to outcome (either death or recovery) for males and females (p=0.29). The expected mean for the time from admission to outcome (either death or recovery) is 33.2 days (96% CI: 30.96, 35.70), accounting for censorship, i.e. unobserved outcomes. The number of days from (first) symptom onset to hospital admission has an expected mean of 7.0 (6.5, 7.4) and a variance of 47.9 (41.6, 55.7). 
...
```{r agepyramid, echo = FALSE, eval=FALSE}
...
```{r symptomcombos, echo=FALSE, eval=FALSE}
...
status.by.time.after.admission.2(patient.data)
```
