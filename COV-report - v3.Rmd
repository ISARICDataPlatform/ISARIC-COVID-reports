...
dir.path <- "/Users/mdhall/Nexus365/Emmanuelle Dankwa - COVID Reports/"
dir.path2 <- "/Users/Hp/OneDrive - Nexus365/COVID Reports/"

setwd(dir.path)

#setwd(dir.path2)

source("shiny/COVID-dashboard/shared.R")
source("shiny/COVID-dashboard/functions2.R")
...
# COVID-19 Report: 18th March, 2020 {-}



# Summary

The results in this report have been produced using data from the  International Severe Acute Respiratory and Emerging Infection Consortium (ISARIC) COVID-19 database up to 17 March 2020. This data were contributed by 65 sites across 15 countries, 


Up to 17 March 2020, data have been entered for 251 patients. The cohort is made up of 115 males, 99 females - sex was unreported for 37 cases. The median age is 50 years. Follow-up is ongoing for 78 patients.  167 patients have recovered and 6 have died. Cough was among the most common symptoms of presentation (114, 45%). The total number of admissions to the intensive care ICU was seven (7).


Among this cohort, there was no significant difference in the duration from admission to outcome (either death or recovery) for males and females (p=0.82). The expected mean for the time from admission to outcome (either death or recovery) is 34.6 days (96% CI: 32.2, 37.4), accounting for censorship, i.e. unobserved outcomes. The number of days from (first) symptom onset to hospital admission has an expected mean of 6.6 (6.3, 7.1) and a variance of 36.8 (34.5, 45.9). Refer to the Methods section for details on methods.
...
Distribution of combinations of the four most common symptoms present at admission:
...
Distribution of combinations of the four most common comorbidities present at admission:
...
Prevalence of all recorded comorbidities and symptoms at admission:
...
Distribution of patient statuses by time since admission:
...
Length of hospital stay by sex:
...
Length of hospital stay by age group:
...
Hospital fatality ratio (based only on completed outcomes):
...
All patients and outcomes by date of admission:
...
Histograms are used to display the observed data and black overlaying curves represent the maximum likelihood Gamma fit to the data. Histogram bins are labeled at the respective midpoints.


Time from sympton onset to admission:
...
Time from admission to hospital exit (either by recovery or death): 
...
All patients by country and outcome:
...
Graphs have been used to represent the age distribution of patience by sex and status (censores, death, recovered), the prevalence of individual symptoms  - and combinations of them - on admission, the prevalence of individual comorbidities  - and combinations of them - on admission, the length of hospital stay by sex and age group and the distribution of patient statuses by time since admission. In addition, the number of cases recruited by country and site, as well as the case count by status, has been represented.


To obtain estimates for the distributions of time from symptom onset to hospital admission and the time from admission to outcome (death or recovery), Gamma distributions are fitted to the observed data, allowing for censored observations. 
