...
grid.draw(plot.comorb.by.age(patient.data))
...
grid.draw(plot.sx.by.age(patient.data, admission.symptoms))
...
grid.draw(plot.signs.by.age(patient.data))
...
grid.draw(plot.blood.results.by.age(patient.data))
